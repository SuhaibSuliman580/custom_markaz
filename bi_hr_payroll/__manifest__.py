...

{
    ...
    """,
    "author": "BROWSEINFO",
    "website" : "https://www.browseinfo.com/demo-request?app=bi_hr_payroll&version=17&edition=Community",
    'depends': [
        'hr_contract',
        'hr_holidays',
    ],
    ...
    'auto_install': True,
    "installable": True,
    "live_test_url": 'https://www.browseinfo.com/demo-request?app=bi_hr_payroll&version=17&edition=Community',
